        ...
        <Row className="mb-8">
          <Col md={4} xs={5}>
            ...
            <Nav className="footer-nav">
              <Nav.Link
                ...
                smooth
                to="/#"
                className="footer-text hover:text-indigo-500"
              >
                Home
              </Nav.Link>
              <Nav.Link
          ...
          <Col md={4} xs={5}>
            ...
            <p className="footer-text">
              ...
              user-friendly applications and solving complex problems with
            ...
            <div className="contact-follow-wrapper">
              <div className="contact">
                ...
                <p className="footer-text flex">
                  <a
                    ...
                    className="footer-link mx-8"
                  >
                    <img
                      src={MailLogo}
                      className="footer-icon h-8"
                      alt="Mail Logo"
                    />
                  </a>
                </p>
              ...
              <div className="follow">
                ...
                <div className="footer-icons">
                  ...
                  <a
                    href="https://www.linkedin.com/in/praveenkumar2k33/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
                  ...
                  <a
                    href="https://github.com/PraveenKumara2k33"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img
