    ...
    <header className=" p-4 header">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav className="hidden lg:flex space-x-6">
          <Link to="/" smooth className="navbtn hover:text-violet-800">
            Home
          </Link>
          <Link to="/#about" smooth className="navbtn hover:text-violet-800 ">
            About
          </Link>
          <Link
            to="/#qualification"
            smooth
            className="navbtn hover:text-violet-800"
          >
            Qualification
          </Link>
          <Link to="/#skills" smooth className="navbtn hover:text-violet-800 ">
            Skills
          </Link>
          <Link to="/#projects" smooth className="navbtn hover:text-violet-800">
            Projects
          </Link>
          <Link
            to="/#publication"
          ...
          <Link to="/#footer" smooth className="navbtn hover:text-violet-800">
            Footer
          </Link>
        </nav>
        ...
        <div className="lg:hidden">
          <button onClick={toggleMenu}>
            {isOpen ? (
              ...
              <FaBars size={28} className="text-gray-400" />
            )}
          </button>
        </div>
          ...
          <nav className="offcanvas-menu lg:hidden fixed top-0 right-0 w-3/4 h-full bg-black p-6 shadow-lg z-50 transition-transform duration-300 ease-in-out transform translate-x-0">
            ...
            <div className="space-y-6 flex flex-col items-start text-start ">
              <Link
                to="/"
                smooth
                className="navbtn hover:text-violet-800 w-40"
                onClick={toggleMenu}
              >
                Home
              </Link>
