    ...
    <div className="vertical-scroll-snap lg:text-sm/8">
        ...
        <div className="flex section1">
          ...
          <div className="">
            <h3 className="text-lg sm:text-2xl">
              Project Title: Web-Based Chat Application
            </h3>
            ...
            <div className="mt-3 border w-fit p-2">
              <a
                href="https://github.com/PraveenKumara2k33/Web-Based-Chat-Application.git"
                target="_blank"
                className="flex"
              >
      ...
      <section className="stacking-slide text-start">
        <p className="text-xl">
          ...
          focusing on enabling real-time communication and enhancing user
          engagement through efficient messaging solutions.
        </p>
          ...
          <div className="">
            ...
            >
              ...
              <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                <li>
                  Utilized AJAX for live, instant message updates between users,
                  without page reload.
                </li>
                <li>
                  Delivered a smooth messaging experience with dynamic,
              ...
              <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                <li>
                  Built a responsive front-end for intuitive user interaction
                  across devices (mobile, tablet, desktop).
                </li>
                <li>
                  Integrated dynamic elements using JavaScript and CSS to
        ...
        <div className="flex section1">
          ...
          <div className="">
            ...
            >
              ...
              <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                <li>
                  Secure user authentication through Java Servlets and JSP.
                </li>
                <li>
                  Implemented session handling using Apache Tomcat to track user
                  activity.
                </li>
                <li>
                  Logout functionality to clear session and end user
                  interactions safely.
                </li>
              </ul>
              ...
              <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                <li>
                  Designed a sign-up system with form validation and error
                  handling.
                </li>
                <li>
                  Stored user credentials in a secure format, encrypting
                  passwords in the MySQL database.
                </li>
              </ul>
            </ul>
            <div className="flex space-x-5 mt-2 pt-3">
        ...
        <div className="flex section1">
          ...
          <div className="">
            ...
            >
              ...
              <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                <li>
                  Created MySQL tables to manage message data, including
                  sender/receiver, message content, and timestamps.
                </li>
                <li>
                  Enabled storage and retrieval of chat history for user access.
                </li>
              </ul>
              <li>User Management</li>
              <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                <li>
                  Designed database schema to handle user details, including
                  login information and session tracking.
                </li>
                <li>
                  Implemented user state management (online/offline status) in
        ...
        <div className="flex section1">
          ...
          <div className="">
            ...
            >
              ...
              <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                <li>
                  Updated online/offline status for users dynamically through
                  AJAX requests.
                </li>
              </ul>
              <li>Notifications</li>
              <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                <li>
                  Real-time notifications for new messages or important events.
                </li>
              </ul>
              <li>Error Handling</li>
              <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                <li>
                  Front-end validation for user inputs, and robust back-end
                  exception handling.
                </li>
              </ul>
              <li>Security</li>
              <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                <li>
                  Used input validation to protect against SQL injection and
                  other vulnerabilities.
                </li>
                <li>
                  Managed secure sessions and encrypted password storage to
                  safeguard user data.
                </li>
              </ul>
            </ul>
        ...
        <div className="flex section1">
          ...
          <div className="">
            ...
            <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
              ...
              >
                <li>
                  Utilized AJAX to enable asynchronous data fetching, ensuring a
                  seamless real-time messaging experience without full page
                  reloads.
                </li>
              </ul>
              ...
              <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                <li>
                  Handled secure sessions using Apache Tomcat, allowing
                  persistent login states across the application.
                </li>
              </ul>
            </ul>
            <div className="flex space-x-5 mt-2 pt-3">
