  ...
  return (
    <div className="vertical-scroll-snap">
      ...
      <section className="stacking-slide text-start">
        <h1 className='text-center text-3xl sm:text-5xl my-5 RestaurantHeading'>Web Development</h1>
        ...
        <div className=''>
        <h3 className='text-lg sm:text-2xl'>Project Title: Real-Time E-Commerce Website with Secure Authentication</h3>
        ...
        <div className='flex space-x-5 mt-2 flex-wrap'>
          ...
          <div className='mt-3 border w-fit p-2'>
            <a href="https://github.com/PraveenKumara2k33/E-Commerce.git" target='_blank' className='flex'><img src={GithubLogo} alt="" className='w-8' /> <span className='ml-2 my-1'>GitHub</span> </a>
          </div>
        </div>
        </div>  
      ...
      <section className="stacking-slide text-start">
        <p className='text-xl'>
          ...
          focusing on secure user authentication and seamless real-time interactions 
          to enhance customer engagement and improve the shopping experience.
        </p>
      ...
      <section className="stacking-slide text-start">
        <div className='flex section1'>
          ...
          <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
            <li>Developed responsive and user-friendly interfaces using ReactJS.</li>
            <li>Employed Bootstrap for grid layout and Tailwind CSS for custom styling, ensuring a modern aesthetic.</li>
            <li>Implemented accessibility features to enhance usability for all users.</li>
          </ul>
            <div className='flex space-x-5 mt-2 flex-wrap'>
              <img src={CssLogo} className='w-10' alt="" />
              <img src={BootstrapLogo} className='w-10' alt="" />
      ...
      <div className='flex section1'>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          <li>Integrated Socket.IO for real-time notifications, such as new product arrivals and updates on customer orders.</li>
          <li>Enabled live chat support for immediate customer assistance, improving engagement.</li>
        </ul>
          <div className='flex space-x-5 mt-2 flex-wrap'>
              <img src={CssLogo} className='w-10' alt="" />
              <img src={BootstrapLogo} className='w-10' alt="" />
      ...
      <div className='flex section1'>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          <li>Utilized Node.js to create RESTful APIs for handling requests from the frontend.</li>
          <li>Managed data storage and retrieval using JSON files for products and user information, allowing for easy updates.</li>
        </ul>
          <div className='flex space-x-5 mt-2 flex-wrap'>
            <img src={CssLogo} className='w-10' alt="" />
            <img src={BootstrapLogo} className='w-10' alt="" />
      ...
      <div className='flex section1'>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          <li>Implemented functionalities for product updates, including adding, editing, and removing items.</li>
          <li>Designed a search and filter system to enhance product discoverability.</li>
        </ul>
          <div className='flex space-x-5 mt-2 flex-wrap'>
            <img src={CssLogo} className='w-10' alt="" />
            <img src={BootstrapLogo} className='w-10' alt="" />
      ...
      <div className='flex section1'>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          <li>Developed secure authentication mechanisms, including user registration, login, and logout functionalities.</li>
          <li>Ensured password hashing and secure session management to protect user information.</li>
        </ul>
          <div className='flex space-x-5 mt-2 flex-wrap'>
            <img src={CssLogo} className='w-10' alt="" />
            <img src={BootstrapLogo} className='w-10' alt="" />
      ...
      <div className='flex section1'>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          <li>Applied custom CSS for unique design elements, such as buttons and forms, to create a cohesive visual identity.</li>
          <li>Created responsive designs to ensure optimal viewing across various devices.</li>
        </ul>
          <div className='flex space-x-5 mt-2 flex-wrap'>
            <img src={CssLogo} className='w-10' alt="" />
            <img src={BootstrapLogo} className='w-10' alt="" />
      ...
      <section className="stacking-slide text-start">
      <div className=''>
        <h1 className='text-center text-3xl sm:text-5xl my-2'>Page Structure</h1>
      ...
      <div className='flex section1'>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          <li>User-friendly interface for login with email and password fields.</li>
          <li>Error messages for incorrect credentials.</li>
          <li>Options for &quot;Remember Me&quot; and password recovery.</li>
        </ul>
          <div className='flex space-x-5 mt-2 flex-wrap'>
            <img src={CssLogo} className='w-10' alt="" />
            <img src={TailWindLogo} className='w-10' alt="" />
      ...
      <div className='flex section1'>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          ...
          <li>Quick access to popular categories and search functionality.</li>
          <li>Welcome message with personalized greetings for logged-in users.</li>
        </ul>
          <div className='flex space-x-5 mt-2 flex-wrap'>
            <img src={CssLogo} className='w-10' alt="" />
            <img src={BootstrapLogo} className='w-10' alt="" />
      ...
      <div className='flex section1'>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          <li>Comprehensive product listings with filters (category, price, etc.).</li>
          <li>Sorting options (e.g., by popularity, price, and newest).</li>
          <li>Pagination for seamless navigation through multiple product pages.</li>
        </ul>
          <div className='flex space-x-5 mt-2 flex-wrap'>
            <img src={CssLogo} className='w-10' alt="" />
            <img src={BootstrapLogo} className='w-10' alt="" />
      ...
      <div className='flex section1'>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          ...
          <li>Option to compare features and prices with the selected product.</li>
      ...
      <div className='flex section1'>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          <li>Section for users to leave reviews and ratings for products.</li>
          <li>Display of existing customer reviews to build trust and credibility.</li>
      ...
      <div className='flex section1'>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          ...
          <li>Highlights of differences in features, prices, and user ratings.</li>
          <li>Call-to-action buttons to encourage purchasing or further exploration.</li>
        </ul>
          <div className='flex space-x-5 mt-2 flex-wrap'>
            <img src={CssLogo} className='w-10' alt="" />
            <img src={BootstrapLogo} className='w-10' alt="" />
      ...
      <div className='flex section1'>
        ...
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          <li>Detailed view of the selected product, including images, descriptions, and price.</li>
      ...
      <div className='flex section1'>
        ...
        <h3 className='text-3xl sm:text-5xl my-2'>Buy Product Page</h3>
        <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
          <li>Secure checkout process with options for guest checkout or user login.</li>
          <li>Input fields for shipping information, payment methods, and order summary.</li>
          <li>Confirmation of order placement and estimated delivery dates.</li>
        </ul>
          <div className='flex space-x-5 mt-2 flex-wrap'>
            <img src={CssLogo} className='w-10' alt="" />
            <img src={BootstrapLogo} className='w-10' alt="" />
