...
const WordPressPage = () => {
  ...
  return (
    <div className="vertical-scroll-snap lg:text-sm/8">
        ...
        <div className="flex section1">
          ...
          <div className="">
            <h3 className="text-lg sm:text-2xl">
              Project Title: Optimizing WordPress with AI and Customization
            </h3>
      ...
      <section className="stacking-slide text-start">
        <p className="text-xl">
          Designed and implemented a customized WordPress site, focusing on
          optimizing user interaction and engagement through AI integration and
        ...
        <div className="flex section1">
          ...
          <div className="mx-5">
            ...
            <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
              <li>
                Integrated a real-time AI chatbot to enhance user interaction
                and support, providing instant responses and improving overall
                engagement.
              </li>
              <li>
                Optimized the chatbot’s behavior for quick response times and
                seamless integration with the website&apos;s interface, leading
      ...
      <section className="stacking-slide text-start">
        <div className="flex section1">
          ...
          <div className="mx-5">
            ...
            >
              <li>
                Developed a dynamic, interactive image gallery with pagination
                features to improve content organization and user browsing
                experience.
              </li>
              <li>
                Increased user engagement by 30% through a visually appealing
                and easy-to-navigate image display system, enhancing site
                interaction metrics.
              </li>
            </ul>
            <div className="flex space-x-5 mt-2 pt-3">
      ...
      <section className="stacking-slide text-start">
        <div className="flex section1">
          ...
          <div className="mx-5">
            ...
            >
              <li>
                Tailored the website’s appearance and functionality using custom
                web styles to enhance readability and user experience.
              </li>
              <li>
                Achieved a 20% improvement in user experience by focusing on
                optimizing page load times, font readability, and responsive
