...
const workData = [
  {
    ...
    description:
      "Pioneering a Frontend Web Developer internship, elevating skills in HTML, CSS, and JavaScript.",
  ...
  },
  {
    ...
    description:
      "Underwent comprehensive training, mastering key concepts and completing assigned tasks.",
    extraDescription:
      "Additional details about the WordPress Developer Internship.",
    path: "/details",
  },
  {
    type: "work",
    ...
    description:
      "Completed an intensive training program focusing on HTML, CSS, JavaScript, and React.js.",
    extraDescription:
      "Additional details about the Frontend Developer Internship.",
    path: "/details",
  },
  {
    type: "work",
    ...
    description:
      "Trained extensively in web development and advanced Java technologies.",
...
function Qualification() {
  return (
    <>
      <h1
        className="font-serif text-5xl my-10 Qualification"
        id="Qualification"
      >
        Qualification
      </h1>
