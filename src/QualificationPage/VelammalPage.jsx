    ...
    <div className="velammal-page">
      ...
      <div className="velammal-content">
        ...
        <div className="mt-3">
          ...
          <p>
            <strong>Stream:</strong> Information Technology (IT)
          </p>
          <p>
            <strong>Duration:</strong> Aug 2019 – May 2023
          </p>
          <p>
            <strong>CGPA:</strong> First Class Distinction (
            <span className="">8.56</span>)
          </p>
        </div>
        ...
        <div className="mt-4">
          ...
          <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
            <li>
              <strong>Core Courses:</strong> Operating Systems, Data Structures,
              Analysis of Algorithms, Artificial Intelligence, Advanced OOPs,
              and more.
            </li>
            <li>
              <strong>Research Publication:</strong> Authored and published a
              paper titled &quot;Black Box for Vehicle to Track Performance and
              Driving Behavior&quot;.
            </li>
          </ul>
        </div>
        ...
        <div className="mt-4">
          ...
          <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
            ...
            <li>
              Extensive coding practice and problem-solving through{" "}
              <a
                href="https://www.skillrack.com/faces/resume.xhtml?id=320627&key=b613186118ca2f8cfe1ceba5d9d4b9614c38cfda"
                target="_blank"
                rel="noopener noreferrer"
                className="underline decoration-pink-500 hover:bg-pink-500 hover:p-2"
              >
                Skillrack
              </a>{" "}
              and{" "}
              <a
                href="https://www.hackerrank.com/profile/apraveenkumar720"
                target="_blank"
                rel="noopener noreferrer"
                className="underline decoration-teal-400 hover:bg-teal-400 hover:p-2"
              >
                HackerRank
              </a>{" "}
              platforms.
        ...
        <div className="mt-4">
          ...
          <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
            <li>
              Strengthened analytical and programming skills through competitive
              coding.
            </li>
            <li>
              Collaborated on real-world projects and gained practical knowledge
              of advanced software technologies.
            </li>
          </ul>
        </div>
      </div>
